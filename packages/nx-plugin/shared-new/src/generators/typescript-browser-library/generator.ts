...
function normalizeOptions(tree: Tree, options: TypescriptBrowserLibraryGeneratorSchema): NormalizedSchema {
...
export default async function (tree: Tree, options: TypescriptBrowserLibraryGeneratorSchema) {
    ...
    normalizedOptions.projectName,
    {
      ...
      targets: {
        ...
        lint: {
          ...
          "options": {
            "lintFilePatterns": [
              path.join(normalizedOptions.projectRoot,'src','**','*.ts')
            ]
          }
        },
        format: {
